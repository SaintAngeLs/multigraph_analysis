...
plt.scatter(df["Rozmiar"], df["Czas dokładnego wykrycia cyklu"], label="Dokładny czas wykrycia", marker="o")
plt.scatter(df["Rozmiar"], df["Czas przybliżonego wykrycia cyklu"], label="Przybliżony czas wykrycia", marker="s")
...
plt.figure(figsize=(12, 6))
plt.scatter(df["Rozmiar"], df["Dokładna maksymalna długość cyklu"], label="Dokładna długość cyklu", marker="o")
plt.scatter(df["Rozmiar"], df["Przybliżona maksymalna długość cyklu"], label="Przybliżona długość cyklu", marker="s")
plt.xlabel("Rozmiar grafu")
...
plt.figure(figsize=(12, 6))
plt.scatter(df["Rozmiar"], df["Dokładna liczba maksymalnych cykli"], label="Dokładna liczba cykli", marker="o")
plt.scatter(df["Rozmiar"], df["Przybliżona liczba maksymalnych cykli"], label="Przybliżona liczba cykli", marker="s")
plt.xlabel("Rozmiar grafu")
...
plt.figure(figsize=(12, 6))
plt.scatter(df["Rozmiar"], df["Dokładność długości cyklu (%)"], label="Dokładność długości cyklu", marker="o")
plt.scatter(df["Rozmiar"], df["Dokładność liczby cykli (%)"], label="Dokładność liczby cykli", marker="s")
plt.xlabel("Rozmiar grafu")
...
plt.figure(figsize=(12, 6))
plt.scatter(df["Rozmiar"], df["Stosunek czasu (przybliżony/dokładny)"], label="Stosunek czasu", marker="o")
plt.xlabel("Rozmiar grafu")
