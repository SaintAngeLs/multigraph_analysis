...
\begin{itemize}
    ...
    \begin{itemize}
        \item Rozmiar grafu: \(4\)
        \item Wszystkie cykle: \(0 \to 1 \to 3 \to 0\)
        \item Cykl Hamiltona: Nie
        \item Minimalne rozszerzenie dla cyklu Hamiltona: \(1\)
        \item Maksymalna długość cyklu: \(3\)
    \end{itemize}
    ...
    \begin{itemize}
        \item Rozmiar grafu: \(4\)
        \item Wszystkie cykle: \(0 \to 1 \to 2 \to 0\)
        \item Cykl Hamiltona: Tak \(1 \to 2 \to 3 \to 1\)
        \item Minimalne rozszerzenie dla cyklu Hamiltona: \(0\)
        \item Maksymalna długość cyklu: \(3\)
    \end{itemize}
    \item Metryka podobieństwa pomiędzy grafem 1 i grafem 2: \(5\)
    \item Metryka podobieństwa pomiędzy grafem 1 i grafem 2 liczona metodą aproksymacyjną: \(5\)
\end{itemize}
