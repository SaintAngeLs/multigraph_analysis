...
Metryka Earth Mover's Distance (EMD) pomiędzy $D_1$ i $D_2$ to minimalny koszt przekształcenia $D_1$ w $D_2$, gdzie koszt przekształcenia stopnia $d_i$ w $d_j$ wynosi $|d_i - d_j|$. Metryka EMD pomiędzy $D_1$ i $D_2$ to suma kosztów przekształceń dla wszystkich par stopni wierzchołków:
\[
