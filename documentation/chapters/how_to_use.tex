...
\begin{itemize}
    ...
    \item \textbf{documentation.pdf} - Plik dokumentacji projektu, w tym opis algorytmów, dowody i przykłady użycia.
    \item \textbf{graph\_gen.exe} - Program generujący przykładowe grafy o różnych strukturach.
...
Skrypt wykonuje analizę predefiniowanych przypadków testowych oraz generuje dodatkowe testy za pomocą programu \texttt{graph\_gen}. Wyniki testów są zapisywane w katalogu \texttt{results/}.
